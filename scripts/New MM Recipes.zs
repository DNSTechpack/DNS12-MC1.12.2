...
## Item Inputs
mods.actuallyadditions.Empowerer.addRecipe(<modularmachinery:blockinputbus:2>, <modularmachinery:blockinputbus:1>, <ironchest:iron_chest:3>, <ironchest:iron_chest:3>, <ironchest:iron_chest:3>, <ironchest:iron_chest:3>, 50000, 300, [0.5, 0.0, 0.0]);
mods.actuallyadditions.Empowerer.addRecipe(<modularmachinery:blockinputbus:3>, <modularmachinery:blockinputbus:2>, <ironchest:iron_chest>, <ironchest:iron_chest>, <ironchest:iron_chest>, <ironchest:iron_chest>, 50000, 300, [0.5, 0.0, 0.0]);
mods.actuallyadditions.Empowerer.addRecipe(<modularmachinery:blockinputbus:4>, <modularmachinery:blockinputbus:3>, <ironchest:iron_chest:1>, <ironchest:iron_chest:1>, <ironchest:iron_chest:1>, <ironchest:iron_chest:1>, 50000, 300, [0.5, 0.0, 0.0]);
mods.actuallyadditions.Empowerer.addRecipe(<modularmachinery:blockinputbus:5>, <modularmachinery:blockinputbus:4>, <ironchest:iron_chest:2>, <ironchest:iron_chest:2>, <ironchest:iron_chest:2>, <ironchest:iron_chest:2>, 50000, 300, [0.5, 0.0, 0.0]);
...
##Fluid Inputs
mods.actuallyadditions.Empowerer.addRecipe(<modularmachinery:blockfluidinputhatch:2>, <modularmachinery:blockfluidinputhatch:1>, <pressure:tank_block>, <pressure:tank_block>, <pressure:tank_block>, <pressure:tank_block>, 50000, 300, [0.5, 0.0, 0.0]);
